...
(function() {
    ...
    ready(document, function() {
        var nameNode = document.querySelectorAll('.pv-top-card-section__name');
        if (nameNode) {
            var fullName = nameNode[0].textContent;
            var company = '';
            var companyNode = document.querySelectorAll('.pv-top-card-v2-section__company-name');
            if (companyNode) {
        ...
        waitForKeyElements (".ci-email", function() {
            var emailNode = document.querySelectorAll('.ci-email a');
            if (emailNode) {
